class OrderAddress
  ...
  attr_accessor :user_id, :item_id, :postal_code, :prefecture_id, :city_name, :street_address, :building_name, :phone_number, :token

  with_options presence: true do
    validates :user_id
    validates :item_id
    validates :postal_code, format: { with: /\A\d{3}-\d{4}\z/, message: "は無効な形式です。例: 123-4567" }
